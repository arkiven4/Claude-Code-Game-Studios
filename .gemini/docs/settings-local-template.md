...
Gemini CLI supports different permission modes. Recommended for game dev:

### During Development (Default)
Use **normal mode** — Gemini asks before running most commands. This is safest
for production code.
...
### During Code Review
Use **read-only** permissions — Gemini can read and search but not modify files.
