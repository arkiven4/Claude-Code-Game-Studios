# GEMINI.local.md Template

Copy this file to the project root as `GEMINI.local.md` for personal overrides.
...
- IDE: VS Code with Gemini CLI extension
...
1. Copy this template to your project root: `cp .gemini/docs/GEMINI-local-template.md GEMINI.local.md`
2. Edit to match your preferences
3. Verify `GEMINI.local.md` is in `.gitignore` (Gemini CLI reads it from the project root)
